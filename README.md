...
4. **Ограничения для файлов**:
   ...
   - Максимальное количество файлов за одну операцию: 20
...
- Выбор раздела "Регистрация" и регистрация. После регистрации пользователь перейдет в хранилище
...
- Перетаскивание файлов (Drag and Drop) или выбор файла (кнопка "Выбрать файл")
- Комментарий к файлу (необязателен) и загрузка файла в хранилище пользователя. Комментарий к файлу можно редактировать
...
- Вместе с админ-панелью администраторы могут пользоваться собственным хранилищем для хранения рабочих файлов (руководство администратора, шаблоны ответов на вопросы пользователей и т.п.). Принцип работы хранилища такой же как у обычных пользователей приложения
...
# Корректировка my-ip-address под конкретный IP-адрес (например, 95.163.220.37)
server {
    listen 80;
...
### 4.7. Проверка работы приложения
