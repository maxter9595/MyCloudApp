...
![](./demo/2-functionality/1-auth.gif)
...
![](./demo/2-functionality/2-storage.gif)
...
![](./demo/2-functionality/3-admin-panel.gif)
...
* **Примечание**: инструкция по получению SSH-ключа приводится для пользователей Windows. В случае ОС Linux следует изучить статью из habr.com: [https://habr.com/ru/articles/897654/](https://habr.com/ru/articles/897654/)
