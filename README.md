...
### 4.2. Генерация SSH-ключа на сервере
...
### 4.5. Привязка SSH-ключа к GitHub
...
### 4.6.Настройка файла SSH-конфигурации. Проверка подключения к GitHub
...
### 4.7. Задаем значения secret-параметров GitHub-репозитория для автодеплоя
